...
| TeamSnap | Senior Marketing Manager | never | `Withdrawn` | Built, not submitted | Fit 58. Josh passed after review. Materials kept if it comes back. |
| Outpost | Reddit Marketer | never | `Withdrawn` | Built, abandoned at application form | Fit 55. Stopped at the free-text questions. Materials kept. |
