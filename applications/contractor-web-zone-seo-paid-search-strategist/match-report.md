# Match Report — SEO & Paid Search Strategist, Home Services, Contractor Web Zone

- **Role:** SEO & Paid Search Strategist — Home Services (roofing and contractor clients)
- **Company:** Contractor Web Zone — marketing and software platform for roofing/home-service contractors
- **Engagement:** Full-time independent contractor (1099), ~40 hrs/week, remote
- **Comp:** $32.00 – $40.00/hour
- **Date:** August 27, 2026
...
No hard knockouts on location or authorization (1099 contractor, remote). One item is a
real decision, not a formality, and the application itself asks Josh to answer it directly
(Q5).

| Item | Classification | Status |
| :--- | :--- | :--- |
| **~40 hrs/week, Mon–Fri, disclose other commitments (Q5)** | Application-form | **BLOCKED — needs Josh's real answer.** This does not bar concurrent work outright the way the Local SEO Partners posting did, but it does require honest disclosure of Solenzo. Drafted the question with the decision framed, not answered. See `application-answers.md`. |
| **Portfolio/audit sample** | Not explicitly required here | Unlike Local SEO Partners, this posting does not demand a portfolio upfront — Q4 asks for a narrative account example instead, which has been answered honestly, including the one number that isn't on file. |
| Remote, 1099 contractor | Application-form | OK. |
| Compensation | Application-form | Published at $32–$40/hr; confirm expectation if asked directly. |
| 3+ years hands-on SEO | Resume-evidenced | **Covered.** Technical SEO audits, keyword/competitor research documented at Solenzo, Wix, and (adjacent) Level Agency. |
| Local SEO strategy execution | Resume-evidenced | **Covered.** Solenzo local-service client work; Birdeye Google Business Profile / local-visibility work. |
| Building and managing Google Ads campaigns | Resume-evidenced | **Covered, strongly.** Solenzo: built from the ground up and manages daily, including the targeting/negative-keyword diagnostic story used in Q4. |
...
Contractor Web Zone's screening or hiring decision.* See `fit.png`.
...
1. **The lead-quality-over-CPL judgment is real, not adopted for this application.** The
   Solenzo Google Ads diagnosis directly demonstrates the exact discipline the posting
   asks for, and it's the answer to Q4 as well as the resume's lead bullet.
2. **Google Ads ownership end to end** — building from scratch and managing daily, for
   local service clients specifically.
3. **Runs client calls himself**, with no account manager between him and the business
   owner, for a career, not just in this role.
4. **Genuine local-service-business client base already**, plus home-services specifically
   at Birdeye.
...
1. **Q5 is the real gate here — answer it honestly before submitting.** How many hours a
...
- **A real CPL, spam-rate, or conversion-lift number from the Solenzo Google Ads account**
  used in Q4. This is now the single most recurring gap across every paid-media and
  growth application in this batch (fifth+ time flagged) and the highest-value thing to
  capture via `/excavate-profile`.

## Output files

- `resume.pdf` / `resume.docx` — 1 page, modern style, selectable text, reverse-chronological (verified)
- `cover-letter.pdf` / `cover-letter.docx` — 1 page, matching letterhead
- `application-answers.md` — draft answers to all six required application questions (Q5 blocked, needs Josh's input)
- `fit.png` — score meter
