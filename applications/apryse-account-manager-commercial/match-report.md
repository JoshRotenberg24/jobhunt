# Match Report — Account Manager, Commercial, Apryse

**Role:** Account Manager, Commercial
**Company:** Apryse (document processing SDK / software technology, customers include IBM, Autodesk, DocuSign, Boeing, Microsoft)
**Location:** In-office or remote, 14 locations including Denver HQ
**Compensation:** $120,000 – $180,000/year (posting notes the top of the range is reserved for candidates with extensive experience, so the "Junior" tag on this listing shouldn't be read too literally)
**Date reviewed:** August 31, 2026

No eligibility cap applies. This is a strong match — the posting's own core asks (multi-year quota overachievement, consultative selling to technical executives, Salesforce) are all directly and repeatedly evidenced in Josh's history.
...
| :--- | :--- | :--- |
| Location (in-office or remote, Denver HQ among 14 locations) | **Resume-evidenced** | Josh is based in Arvada, CO — direct match to the Denver HQ option, and remote is also available. |
| Work authorization | **Application-form requirement** | Confirm on the application. |
...
| Salesforce CRM experience | **Resume-evidenced, strong** | Documented at Birdeye, Wix, and Fivestars. |
| Compensation ($120,000–$180,000) | **Application-form requirement** | A strong, credible range; confirm it aligns with expectations. |
...
Worth applying with real confidence. The posting explicitly says its requirements are "a guide, not a checklist" and welcomes candidates who don't check every box, and the core substance of this role, consultative selling to technical buyers with a sustained quota-overachievement record, is exactly what Josh's Accelo tenure demonstrates.

## Referral

No known connection at Apryse — omitted.
