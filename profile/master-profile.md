...
- Write and publish thought leadership content, newsletters, and educational guides (public writing sample: https://getsolenzo.com/blog; email samples in profile/writing-samples.md) on systems architecture, CRM optimization, and operational growth for B2B audiences.
...
| AI & Automation | Agentic AI, Multi-agent orchestration, LLM workflows, ChatGPT, Claude, Microsoft Copilot (tested/evaluated at Solenzo only, light use, confirmed Sep 2026; frame as "evaluated," not daily use), Claude Code (agentic coding tool; Josh runs his own job-search pipeline, this repo, in it, noted Sep 2026), Prompt Design, Requirements-to-Prompt Translation, Stakeholder Elicitation, Rapid Prototyping |
