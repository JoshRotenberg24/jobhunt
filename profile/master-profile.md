...
| Role Type | Summary |
| :--- | :--- |
| GHL / HubSpot / Marketing Ops | Marketing operations leader and CRM architect with 15+ years in marketing and revenue operations and 5+ years building CRM and marketing-automation systems, primarily in GoHighLevel with hands-on HubSpot client builds. This work builds on more than a decade in account executive and client-facing roles, where owning client relationships, satisfaction, and retention drove revenue; I bring those same client-first instincts to marketing operations and automation for agencies, service-based, and B2B organizations. |
